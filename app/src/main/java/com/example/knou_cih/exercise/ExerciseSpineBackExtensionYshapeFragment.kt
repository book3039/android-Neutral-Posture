...
//'[굽은등]백익스텐션Y'를 클릭하면 띄워지는 프래그먼트
class ExerciseSpineBackExtensionYshapeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val exerciseList = arrayListOf(
            ...
            Exercise(
                0, R.drawable.image_back_extension_y_shape_description,
                "※굽은등으로 늘어난 근육", "슬라이드>>", "", ""
            ),
            Exercise(
                0, R.raw.backextension_y_1, "[동작1]",
                "매트에 엎드려,\n몸을 Y자로 만들어 줍니다", "<", ">"
            ),
            Exercise(
                0, R.raw.backextension_y_2, "[동작2]",
                "등과 팔을 바닥에서\n들어올려 줍니다.\n" +
                        "다리도 자연스럽게\n들어 줍니다.", "<", ">"
            ),
            Exercise(
                R.raw.backextension_y_3, 0, "[전체동작]",
                "1회에 10초간 유지하고,\n3회 반복합니다.", "<", ""
            )
        ...
        binding.textAr.setOnClickListener {
            ...
            intent.putExtra("EXERCISE", "backextensionY")
