...
//목 운동 아이콘들을 보여주는 리사이클러뷰를 위한 어댑터
class ExerciseNeckItemAdapter(val exerciseMenuList: ArrayList<ExerciseMenu>) :
    RecyclerView.Adapter<ExerciseNeckItemAdapter.CustomViewHolder>() {

    interface OnItemClickListener {
        fun onNeckItemClick(pos: Int)
    }
    ...
    override fun onCreateViewHolder(
        ...
        return CustomViewHolder(view).apply {
            itemView.setOnClickListener {
                ...
                mListener.onNeckItemClick(curPos)
            }
        }
    }
