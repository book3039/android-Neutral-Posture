...
//골반 운동 아이콘들을 보여주는 리사이클러뷰를 위한 어댑터
class ExercisePelvisItemAdapter(val exerciseMenuList: ArrayList<ExerciseMenu>) :
    RecyclerView.Adapter<ExercisePelvisItemAdapter.CustomViewHolder>() {

    interface OnItemClickListener {
        fun onPelvisItemClick(pos: Int)
    }
    ...
    override fun onCreateViewHolder(
        ...
        return CustomViewHolder(view).apply {
            itemView.setOnClickListener {
                ...
                mListener.onPelvisItemClick(curPos)
            }
        }
